...
Route::get('/fwfw','Home\IndexController@fwfw')->name('fwfw');
Route::get('/gywm','Home\IndexController@gywm')->name('gywm');
Route::get('/lxwm','Home\IndexController@lxwm')->name('lxwm');
Route::get('/xwzx','Home\IndexController@xwzx')->name('xwzx');
