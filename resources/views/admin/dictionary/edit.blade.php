    ...
    <form class="layui-form " action="{{route('admin.dictionary.update',['id'=>$dictionary->id])}}" method="post">
        ...
        <div class="bottom">
            <div class="button-container">
                <button type="submit" class="layui-btn layui-btn-normal layui-btn-sm" lay-submit="" lay-filter="dictionary-save">
...
@section('script')
    ...
    layui.use(['form','jquery'],function(){
        ...
        form.on('submit(dictionary-save)', function(data){
            $.ajax({
                url:'{{route('admin.dictionary.update',['id'=>$dictionary->id])}}',
                data:data.field,
                dataType:'json',
                type:'post',
