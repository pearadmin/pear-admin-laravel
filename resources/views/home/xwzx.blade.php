    ...
    <div class="main-layout-wrapper" id="smv_AreaMainWrapper" style="background-color: transparent; background-image: none;
        ...
        <div class="main-layout" id="tem-main-layout11" style="width: 100%;">
            ...
            <div class="" id="smv_MainContent" rel="mainContentWrapper" style="width: 100%; min-height: 300px; position: relative; ">
                ...
                <div class="smvWrapper"  style="min-width:1200px;  position: relative; background-color: transparent; background-image: none; background-repeat: no-repeat; background:-moz-linear-gradient(top, none, none);background:-webkit-gradient(linear, left top, left bottom, from(none), to(none));background:-o-linear-gradient(top, none, none);background:-ms-linear-gradient(top, none, none);background:linear-gradient(top, none, none);;background-position:0 0;background-size:auto;" bgScroll="none"><div class="smvContainer" id="smv_Main" cpid="278912" style="min-height:400px;width:1200px;height:1372px;  position: relative; "><div id="smv_con_1_20" ctype="slideset"  class="esmartMargin smartAbs " cpid="278912" cstyle="Style1" ccolor="Item0" areaId="" isContainer="True" pvid="" tareaId=""  re-direction="y" daxis="Y" isdeletable="True" style="height: 400px; width: 100%; left: 0px; top: 0px;z-index:2;"><div class="yibuFrameContent con_1_20  slideset_Style1  " style="overflow:visible;;" >
<!--w-slide-->
        ...
        <div class="w-slide-inner" data-u="slides">
                ...
                <div class="content-box" data-area="Area0">
                    <div id="smc_Area0" cid="con_1_20" class="smAreaC slideset_AreaC">
                        <div id="smv_con_8_22" ctype="area" smanim='{"delay":0.75,"duration":0.75,"direction":"Left","animationName":"slideIn","infinite":"1"}'  class="esmartMargin smartAbs animated" cpid="278912" cstyle="Style1" ccolor="Item0" areaId="Area0" isContainer="True" pvid="con_1_20" tareaId=""  re-direction="all" daxis="All" isdeletable="True" style="height: 119px; width: 524px; left: -1px; top: 152px;z-index:1;"><div class="yibuFrameContent con_8_22  area_Style1  " style="overflow:visible;;" ><div class="w-container" data-effect-name="enterTop">
    <div class="smAreaC" id="smc_Area0" cid="con_8_22">
        <div id="smv_con_9_22" ctype="area"  class="esmartMargin smartAbs " cpid="278912" cstyle="Style1" ccolor="Item0" areaId="Area0" isContainer="True" pvid="con_8_22" tareaId=""  re-direction="all" daxis="All" isdeletable="True" style="height: 88px; width: 88px; left: 1px; top: 7px;z-index:3;"><div class="yibuFrameContent con_9_22  area_Style1  " style="overflow:visible;;" ><div class="w-container" data-effect-name="enterTop">
    <div class="smAreaC" id="smc_Area0" cid="con_9_22">
            </div>
</div></div></div><div id="smv_con_10_22" ctype="text"  class="esmartMargin smartAbs " cpid="278912" cstyle="Style1" ccolor="Item2" areaId="Area0" isContainer="False" pvid="con_8_22" tareaId=""  re-direction="all" daxis="All" isdeletable="True" style="height: 40px; width: 280px; left: 64px; top: 29px;z-index:4;"><div class="yibuFrameContent con_10_22  text_Style1  " style="overflow:hidden;;" ><div id='txt_con_10_22' style="height: 100%;">
    <div class="editableContent" id="txtc_con_10_22" style="height: 100%; word-wrap:break-word;">
        <p><span style="color:#ffffff"><span style="font-size:30px"><strong>新闻资讯</strong></span></span></p>
...
</script></div></div><div id="smv_con_11_22" ctype="text"  class="esmartMargin smartAbs " cpid="278912" cstyle="Style1" ccolor="Item0" areaId="Area0" isContainer="False" pvid="con_8_22" tareaId=""  re-direction="all" daxis="All" isdeletable="True" style="height: 64px; width: 513px; left: 66px; top: 41px;z-index:1;"><div class="yibuFrameContent con_11_22  text_Style1  " style="overflow:hidden;;" ><div id='txt_con_11_22' style="height: 100%;">
    <div class="editableContent" id="txtc_con_11_22" style="height: 100%; word-wrap:break-word;">
        <p><span style="color:rgba(255, 255, 255, 0.2)"><span style="font-size:54px"><strong><span style="font-family:Arial Black">NEWS</span></strong></span></span></p>
    ...
    for (var i = 0; i < tables.length; i++) {
        ...
        if (borderWidth <= 0 || !borderWidth) {
            ...
            $(tab).children("tfoot").children("tr").children("th").addClass('hidden-border')
                    ...
                    <div class="content-box-inner" style="background-image:url(static/images/-48488.jpg);background-position:50% 50%;background-repeat:cover;background-size:cover;background-color:#ffffff;opacity:1"></div>
...
<script type="text/javascript">
...
</div></div><div id="smv_con_90_9" ctype="listnews" smanim='{"delay":0.75,"duration":0.75,"direction":"Up","animationName":"slideIn","infinite":"1"}'  class="esmartMargin smartAbs animated" cpid="278912" cstyle="Style9" ccolor="Item0" areaId="" isContainer="False" pvid="" tareaId=""  re-direction="all" daxis="All" isdeletable="True" style="height: 875px; width: 1269px; left: -28px; top: 460px;z-index:11;"><div class="yibuFrameContent con_90_9  listnews_Style9  " style="overflow:visible;;" >    <div class="w-list xn-resize">
        <ul class="w-list-ul f-clearfix" id="ulList_con_90_9"
            data-title-autolines="1"
            data-desc-autolines="1">
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8470.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48471.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">云空调、私人定制、云网超市－中国企业的“互联网＋”行动</p>
                            <p class="w-list-info ">这样的“云空调”正是得益于“互联网＋”的支撑。鼓励制造企业利用物联网、云计算、大数据等技术，整合产品全生命周期数据，形成面向生产组织全过程的决策服务信息，为产品优化升级提供数据支撑。鼓励企业基于互联网开展在线增值服务，拓展产品价值空间，实现从制造向“制造＋服务”的转型升级。</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8471.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48472.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">新年报业绩告诉你哪家新基建上市公司有投资机会</p>
                            <p class="w-list-info ">目前来看，新型基础设施主要包括信息基础设施、融合基础设施、创新基础设施等三方面内容。而据相关测算，今年的新基建投资可能在1万亿元左右。面对如此明确的投资机会，你将如何把握？</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8469.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48470.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">小微企业贷款难题有望破解</p>
                            <p class="w-list-info ">今年一季度，面对新冠肺炎疫情的严重冲击，我国GDP增速同比下降6.8%。许多市场主体特别是中小微企业生产经营遭遇了比较大的困难，一些个体工商户停业歇业问题较为突出。</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8467.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48468.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">招聘多企业登场 提供两万就业岗位</p>
                            <p class="w-list-info ">今年春节后，企业开工复工时间普遍推迟，招聘用工总量下降。统筹推进经济社会发展工作作出一系列重要指示，提出了强化稳就业举措的明确要求。为此共同发起“春暖花开”大型线上招聘活动。</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8468.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48469.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">创业板改革落地,中国新经济企业如何抓住新机遇</p>
                            <p class="w-list-info ">发布创业板首发注册办法、创业板再融资注册办法等规则，发布创业板改革并试点注册制配套业务规则征求意见稿，创业板改革大幕正式拉开。</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
                <li class="w-list-item hover-effect"  data-effect-name="float-shadow">
                    <a href="/newsinfo/-8466.html" target="_self" class="w-list-link">
                        <div class="w-list-pic">
                            <img class="w-listpic-in" src="static/picture/-48467.jpg" />
                        </div>
                        <div class="w-list-desc">
                            <p class="w-list-title">企业没做好这几点，KPI、OKR、BSC绩效工具都没用</p>
                            <p class="w-list-info ">《当前形势下，企业路在何方?企业家是否该深度反思了?》发出不久，企业现状不太好，业绩下滑严重，2000多名员工面临生存的压力与挑战。</p>
                            <p class="w-list-date ">2021-03-10</p>
                        </div>
                    </a>
                </li>
    ...
    <script>
        var callback_con_90_9 = function () {
            var sv = $("#smv_con_90_9");
...
<div id='pager_con_90_9' jp-htmlid='con_90_9' class='xn-pager xn-resize'  jp-style='Style1_Item4' jp-color='4' jp-align='center' jp-enable='true' jp-device='pc'   jp-first='首页' jp-prev='上一页' jp-next='下一页' jp-last='尾页' jp-more='查看更多' jp-goto='跳转到' jp-go='GO'   jp-totalpages='1' jp-totalcounts='6' jp-pagesize='6' jp-currentpage='1' jp-vpage='5'   jp-listtype='news' jp-cid='0' jp-eid='' jp-datestyle='yyyy-MM-dd' jp-orderbyfield='createtime' jp-orderbytype='desc' jp-skey='' jp-templateid='0' jp-postdata='' jp-callback='callback_con_90_9' jp-es='false' jp-localload='0' ></div><script>$(function(){xnPager('pager_con_90_9');});</script><script type="text/template" id="listTemplate_con_90_9">
    <li class="w-list-item hover-effect" data-effect-name="float-shadow">
        <a href="$data.LinkUrl" target="_self" class="w-list-link">
            <div class="w-list-pic">
                <img class="w-listpic-in" src="static/picture/$data.picurl" />
            </div>
            <div class="w-list-desc">
...
</div></div></div></div><input type='hidden' name='__RequestVerificationToken' id='token__RequestVerificationToken' value='gzFPHJO7kbkn7zRAOgCHGfreV5nhULJcxBTOIWwY9j0p64mzumzZInuQ32RFhOc1AeeAEI1t4yIiSZ4_fIjC5t8JbO23U0GJbtKnkmAcOe81' />
            </div>
        </div>
    </div>
