        ...
        <div class="layui-row layui-col-space10">
            ...
            <div class="layui-col-md3">
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <a target="_blank" href="https://www.yoyoerp.com" class="pear-btn pear-btn-success layui-btn-fluid" style="height: 50px;line-height: 50px;">官 网</a>
                        <br/>
                        <a target="_blank" href="https://www.yoyoerp.com/doc/" class="pear-btn pear-btn-primary  layui-btn-fluid" style="margin-top: 8px;height: 50px;line-height: 50px;">文 档</a>
                        <br/>
    ...
    <script>
        layui.use(['layer', 'echarts', 'element', 'count','topBar'], function() {
            ...
            parent.layer.open({
                ...
                ,area: '500px;'
                ,shade: 0.6
                ,id: 'yue_notice' //设定一个id，防止重复弹出
                ,btn: ['立即充值', '继续使用']
                ,btnAlign: 'c'
                ,moveType: 1 //拖拽模式，0或者1
                ,content: '<div style="padding: 30px; line-height: 22px; background-color: #393D49; color: #fff; font-size: 15px;font-weight: 300;"><p>尊敬的ERP用户您好</p><br><p style="text-indent:2em;">目前小优发现您的账户余额已经 <span style="font-size: 16px;font-weight: 500">小于300元</span> 啦. 当账户余额小于300元后可能会影响您的商品正常物流发货, 但是不会影响到系统的正常使用.</p><br><p style="text-align: right">2021年1月13日<br>YOYOERP官方</p></div>'
                ,success: function(layero){
                    var btn = layero.find('.layui-layer-btn');
                    btn.find('.layui-layer-btn0').attr({
                        href: 'http://erp.sanlilin.cn/'
                        ,target: '_blank'
                    });
                }
            });*/
